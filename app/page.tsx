      ...
      <div className="max-w-6xl mx-auto px-6 py-24 grid md:grid-cols-2 gap-16 items-center relative z-10">
        ...
        <div>
          ...
          <div id="download" className="flex flex-col sm:flex-row gap-4">
            <a
              href="#"
              className="inline-flex items-center gap-3 bg-black text-white border border-white/20 px-5 py-3 rounded-xl hover:bg-zinc-900 transition-colors"
            >
              ...
              <div>
                <div className="text-xs leading-none mb-1 opacity-60 font-normal">Download on the</div>
    ...
    <section className="py-28 relative overflow-hidden">
      ...
      <div className="max-w-2xl mx-auto px-6 text-center relative z-10">
        ...
        <div className="flex justify-center">
          <a
            href="#"
            className="inline-flex items-center gap-3 bg-black text-white border border-white/20 px-7 py-4 rounded-xl hover:bg-zinc-900 transition-colors"
          >
